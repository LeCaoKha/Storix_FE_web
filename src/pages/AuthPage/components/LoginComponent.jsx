...
const LoginComponent = ({ form, handleChange }) => {
  return (
    <div className="flex flex-col items-center w-full space-y-5">
      {/* Google login */}
      <div className="cursor-pointer pl-3 pr-3 py-1 w-fit gap-1 flex items-center mb-6 border-1 border-gray-300 hover:border-[var(--color-primary)] rounded-4xl">
        <div>
          <svg
      ...
      {/* Sign In Button */}
      <button className="cursor-pointer w-full py-3 bg-[var(--color-primary)] text-white rounded-full font-bold hover:brightness-110 transition-all active:scale-95">
        SIGN IN
      </button>
    </div>
  );
