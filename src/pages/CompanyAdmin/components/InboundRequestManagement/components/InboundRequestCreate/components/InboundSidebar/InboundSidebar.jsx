...
const InboundSidebar = ({ onDataChange, summary }) => {
  ...
  const { totalQuantity, totalAmount, orderDiscount, amountToPay } =
    summary || {};
    ...
    <div className="space-y-6">
      ...
      <Card className="!rounded-2xl !shadow-sm !border-slate-100">
        <Text className="block !font-bold !text-slate-700 mb-3 uppercase text-[10px] tracking-widest flex items-center gap-2">
          <Info size={14} className="text-[#38c6c6]" /> Additional Info
        </Text>
        <Input
      ...
      <Card className="!rounded-2xl !border-slate-100 !shadow-sm">
        <Title
          level={5}
          className="!text-slate-800 !mb-6 !font-bold !uppercase !text-xs !tracking-wider"
        >
          Payment
        </Title>
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center">
            <Text className="!text-[#38c6c6] !font-medium !cursor-pointer hover:!underline">
              Order Discount (F6)
            </Text>
            <Text className="!font-bold !text-slate-700">
              {(orderDiscount || 0).toLocaleString()} ₫
            </Text>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <Text className="!text-2xl !font-black !text-[#38c6c6]">
              {(amountToPay || 0).toLocaleString()} ₫
            </Text>
          </div>
        </div>
      </Card>
