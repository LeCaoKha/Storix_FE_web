export const REPORT_TYPES = [
    { value: "OutboundKpiBasic", label: "Outbound KPI Report" },
    { value: "InventoryTracking", label: "Inventory Tracking Report" },
    { value: "InboundKpiBasic", label: "Inbound KPI Report" },
];
        ...
        dataJson: JSON.stringify([
            {
                ...
                unit: "Tấn",
                initialQty: 100, initialValue: 200000000,
                inQty: 50, inValue: 100000000,
                outPrice: 2200000, outQty: 40, outValue: 88000000,
                finalQty: 110, finalValue: 212000000
            },
            {
                sku: "PRO-002",
                name: "Xi măng Hà Tiên PCB40",
                unit: "Bao",
                initialQty: 5000, initialValue: 400000000,
                inQty: 1000, inValue: 80000000,
                outPrice: 85000, outQty: 2000, outValue: 170000000,
                finalQty: 4000, finalValue: 310000000
            }
        ]),
    },
};
